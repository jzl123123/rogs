...
try:
    ...
    from rogs.utils.vis import vis_gaussian_3d
...
from rogs.utils.logging import create_logger
from rogs.utils.image import render_semantic, remap_semantic
from rogs.utils.render import render, render_blocks
from rogs.utils.visualizer import loss2color, depth2color, CustomPointVisualizer
from rogs.models.road import Road
from rogs.models.loss import L1MaskedLoss, CELossWithMask
from rogs.models.exposure_model import ExposureModel
from rogs.models.gaussian_model import GaussianModel2D
from rogs.evalution import eval_bev_metric, eval_z_metric
...
def train(configs):
    ...
    if dataset_cfg["dataset"] == "NuscDataset":
        from rogs.datasets.nusc import NuscDataset as Dataset
    elif dataset_cfg["dataset"] == "KittiDataset":
        from rogs.datasets.kitti import KittiDataset as Dataset
    else:
